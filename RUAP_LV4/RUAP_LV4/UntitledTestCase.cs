...
namespace SeleniumTests
{
    ...
    public class UntitledTestCase
    {
        ...
        public void TheUntitledTestCaseTest()
        {
            ...
            driver.FindElement(By.Id("LastName")).SendKeys("Mijić");
            driver.FindElement(By.Id("Email")).Click();
            driver.FindElement(By.Id("Email")).Clear();
            driver.FindElement(By.Id("Email")).SendKeys("miam@gmail.com");
            ...
            driver.FindElement(By.LinkText("miamijic@gmail.com")).Click();
            driver.FindElement(By.Id("Email")).Click();
            driver.FindElement(By.Id("Email")).Clear();
            driver.FindElement(By.Id("Email")).SendKeys("miamijic@gmail.com");
